! function(e) {
    ...
    e.fn.onepage_scroll = function(n) {
        function o() {
            if (e(window).width() < r.responsiveFallback) {
                ...
                e(document).bind("mousewheel DOMMouseScroll", function(e) {
                    e.preventDefault();
        ...
        e.fn.moveDown = function() {
            ...
            if (next.length < 1) {
                ...
                pos = index * 100 * -1
            } if (typeof r.beforeMove == "function") r.beforeMove(current.data("index"));
        ...
        e.fn.moveTo = function(t) {
            ...
            if (next.length > 0) {
                ...
                if (r.updateURL == false) return false
            }
        };
        ...
        e.each(s, function(t) {
            e(this).css({
                position: "absolute",
                top: topPos + "%"
            }).addClass("slide").attr("data-index", t + 1);
            topPos = topPos + 100;
            if (r.pagination == true) {
        ...
        if (r.pagination == true) {
            e("<ul class='onepage-pagination'>" + paginationList + "</ul>").appendTo(".st-content");
        ...
        e(document).bind("mousewheel DOMMouseScroll", function(t) {
            t.preventDefault();
